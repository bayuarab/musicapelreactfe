...
import { Accordion, AccordionDetails, AccordionSummary, Alert, Avatar, Box, Button, Snackbar, Stack, styled, Typography } from "@mui/material";
		...
		<div>
			<center>
				<Box
					...
					<Avatar alt={auth.nama.split(" ")[0]} src="/static/images/avatar/1.jpg" sx={{ width: { md: 125, xs: 80 }, height: { md: 125, xs: 80 } }} />
                ...
                >
                  Email :
								...
								<Box
									...
									<StyledButton variant="outlined" onClick={() => handleClickOpenDialog("name")}>
										Ubah Nama
									</StyledButton>
									<StyledButton variant="outlined" onClick={() => handleClickOpenDialog("password")}>
										Ubah Password
									</StyledButton>
								</Box>
							</AccordionDetails>
			...
			<UserChangeDataDialog dialogOption={dialogOption} logState={openDialog} onClose={handleCloseDialog} />
