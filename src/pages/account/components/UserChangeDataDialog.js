import { Box, Dialog, DialogContent, DialogTitle, Slide, TextField } from "@mui/material";
					...
					{!dialogState?.oldPass ? (
						...
						<form
							...
							<Box noValidate>
								...
								<DialogButton
									disabled={!PWD_REGEX.test(dialogState?.newPassword) || dialogState?.newPassword !== dialogState.rePassword}
									type="submit"
									fullWidth
									variant="contained"
									style={{
				...
				<DialogContent>
					<form
						...
						<Box noValidate>
							...
							/>
							<DialogButton
								disabled={!postData.nama || !NAME_REGEX.test(postData.nama)}
								type="submit"
								fullWidth
								variant="contained"
								sx={{
