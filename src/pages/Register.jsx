						...
						<Box mt="4vh">
							<form>
								<FormControl sx={{ width: "100%" }}>
									<TextField id="txtNama" margin="normal" required fullWidth label="Nama" name="nama" autoComplete="nama" autoFocus onChange={(event) => addNama(event)} />
								</FormControl>
								<FormControl sx={{ width: "100%" }}>
								...
								<FormControl sx={{ width: "100%" }}>
									<TextField margin="normal" required fullWidth name="rePassword" label="Konfirmasi Password" type="password" autoComplete="current-password" id="txtRePassword" onChange={(event) => addRePassword(event)} />
								</FormControl>
