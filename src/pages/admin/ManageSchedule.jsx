...
import { Alert, Box, Button, Container, Grid, IconButton, Paper, Snackbar, Stack, Table, TableBody, TableContainer, TableHead, TableRow, TextField, Toolbar, Typography } from "@mui/material";
																	...
																	<Grid container sx={{ display: { md: "none", xs: "flex" } }}>
																		<Grid item mb="0.5vh" xs={10} md={6}>
																			<Button
																				...
																				variant="outlined"
																				color="secondary"
																				startIcon={<ModeEdit sx={{ marginLeft: "10px" }} />}
																				aria-label="delete"></Button>
																		</Grid>
																		<Grid item mb="0.5vh" xs={10} md={6}>
																			<Button onClick={() => handleClickOpenLogout(row)} variant="outlined" color="remove" startIcon={<DeleteForever sx={{ marginLeft: "10px" }} />} aria-label="delete"></Button>
																		</Grid>
																	</Grid>
																</StyledTableCell>
															</StyledTableRow>
